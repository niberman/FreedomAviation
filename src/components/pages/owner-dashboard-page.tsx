...
export function OwnerDashboardPage() {
  ...
  const { data: aircraftList, isLoading: aircraftLoading, isError: aircraftError, error: aircraftQueryError } = useQuery({
        ...
        <Card className="mb-6">
          <CardContent className="p-6 text-center text-muted-foreground">
            {aircraftLoading ? (
              ...
              <div>
                <p className="font-medium text-destructive mb-1">Error loading aircraft</p>
                <p className="text-xs">{aircraftQueryError?.message || 'Please try refreshing the page.'}</p>
              </div>
            ) : (
