...
const testimonials = [
  {
    name: "Sarah Mitchell",
    aircraft: "SR22T",
    image: "/images/professional_pilot_s_0ce9d965.jpg",
  ...
  },
  {
    name: "James Anderson",
    aircraft: "Vision Jet",
    image: "/images/professional_pilot_s_544bb357.jpg",
    ...
    <div className="py-20 bg-muted/30">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-semibold mb-4">Trusted by Owner-Pilots</h2>
