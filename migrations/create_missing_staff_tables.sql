...
CREATE TABLE IF NOT EXISTS public.credit_transactions (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  owner_id UUID REFERENCES public.user_profiles(id) NOT NULL,
  transaction_type TEXT NOT NULL, -- earned, used, adjusted, expired
...
CREATE TABLE IF NOT EXISTS public.fuel_records (
  ...
  fuel_type TEXT NOT NULL, -- 100LL, Jet-A, etc
...
CREATE POLICY "Staff can view all hangar spaces" ON public.hangar_spaces
  FOR SELECT USING (
