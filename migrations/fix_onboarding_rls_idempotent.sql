-- Idempotent fix for onboarding_data RLS policies
-- Safe to run multiple times
-- Updated to use user_profiles.role instead of user_roles table
...
-- Allow staff to view all onboarding data for support purposes
-- Fixed to use user_profiles.role instead of user_roles table
