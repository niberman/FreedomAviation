-- Fix onboarding_data RLS policies
-- The table has RLS enabled but no policies, preventing users from accessing their data
...
-- Also allow staff to view all onboarding data for support purposes
