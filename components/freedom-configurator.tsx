...
const classPricing = {
  ...
  class_ii: { base: 550, name: "Class II", aircraft: "SR22 / SR22T / DA40 / Mooney" },
  class_iii: { base: 1000, name: "Class III", aircraft: "Vision / TBM" }
};

const hourRanges = [
  { value: "0-10", label: "0-10 hours", multiplier: 1, details: "1 detail/month", readiness: "Weekly" },
  { value: "10-20", label: "10-20 hours", multiplier: 1.2, details: "2 details/month", readiness: "2x Weekly" },
  { value: "20-30", label: "20-30 hours", multiplier: 1.5, details: "3 details/month", readiness: "3x Weekly" },
  { value: "30-40", label: "30-40 hours", multiplier: 1.8, details: "4 details/month", readiness: "Daily" },
  { value: "40+", label: "40+ hours", multiplier: 2.0, details: "On-demand", readiness: "On-demand" }
];

export function FreedomConfigurator({ open, onOpenChange }: FreedomConfiguratorProps) {
  const [aircraftClass, setAircraftClass] = useState<keyof typeof classPricing>("class_ii");
  const [hourRange, setHourRange] = useState("10-20");
  const [concierge, setConcierge] = useState(false);

  const selectedClass = classPricing[aircraftClass];
  const selectedRange = hourRanges.find(r => r.value === hourRange) || hourRanges[1];
      ...
      <DialogContent className="sm:max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-6 mt-4">
          <div className="space-y-3">
            ...
            <RadioGroup value={aircraftClass} onValueChange={(v) => setAircraftClass(v as keyof typeof classPricing)}>
                ...
                >
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground font-mono">{value.aircraft}</p>
                    </div>
                  </div>
          ...
          <div className="border-t pt-4 space-y-4">
            <div>
              ...
              <p className="text-xs font-semibold text-muted-foreground mb-2">Always Included:</p>
