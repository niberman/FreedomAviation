      ...
      <section className="bg-gradient-to-br from-primary to-primary/80 text-primary-foreground py-20">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-4">Contact Freedom Aviation</h1>
            <p className="text-xl text-primary-foreground/90 max-w-2xl mx-auto">
              Our team is ready to help you elevate your aircraft ownership experience. 
              Reach out for personalized service and expert guidance.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-12">
              ...
              <Card>
                ...
                <CardContent>
                  <form 
                    action="https://formsubmit.co/noah@freedomaviationco.com" 
                    method="POST"
                    className="space-y-4"
                    data-testid="form-contact"
                  >
                    <input type="hidden" name="_subject" value="Freedom Aviation Inquiry" />
                ...
                <Card className="bg-muted/50">
                  <CardContent className="p-6">
                    <p className="text-sm text-muted-foreground">
                      ...
                      Saturday: 9:00 AM - 4:00 PM MT<br />
