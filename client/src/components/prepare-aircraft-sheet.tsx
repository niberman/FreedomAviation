...
export function PrepareAircraftSheet({ open, onOpenChange, aircraft }: PrepareAircraftSheetProps) {
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-2">
                <Checkbox 
                  ...
                  onCheckedChange={(checked) => setTasks({...tasks, staging: !!checked})}
                  data-testid="checkbox-staging"
                />
                <label htmlFor="staging" className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">
                  Stage on Ramp
                </label>
              </div>
              ...
              <div className="flex items-center space-x-2">
                <Checkbox 
                  id="fuel" 
                  checked={tasks.fuel}
                  onCheckedChange={(checked) => setTasks({...tasks, fuel: !!checked})}
              ...
              <div className="flex items-center space-x-2">
                <Checkbox 
                  ...
                  onCheckedChange={(checked) => setTasks({...tasks, fluids: !!checked})}
                  data-testid="checkbox-fluids"
                />
                <label htmlFor="fluids" className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">
              ...
              <div className="flex items-center space-x-2">
                <Checkbox 
                  ...
                  onCheckedChange={(checked) => setTasks({...tasks, avionics: !!checked})}
                  data-testid="checkbox-avionics"
                />
                <label htmlFor="avionics" className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">
